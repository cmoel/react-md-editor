...
var MarkdownEditor = React.createClass({
	...
	renderButton: function renderButton(formatKey, label, action) {
		...
		var isTextIcon = formatKey === 'h1' || formatKey === 'h2' || formatKey === 'h3' ||
			               formatKey === 'undo' || formatKey === 'redo' || formatKey === 'image';
	...
	renderToolbar: function renderToolbar() {
		return React.createElement(
			...
			this.renderButton('undo', 'u', this.undo),
			this.renderButton('redo', 'r', this.redo),
			this.renderButton('link', 'li'),
			this.renderButton('image', 'pic')
		);
	},
